...
/**
 * The template detail screen, shared by `/templates/[slug]` (đồng) and
 * `/malaysia/[slug]` (ringgit).
 *
 * Everything that differs between the two markets arrives in `market`: the
 * currency the price is quoted in, and the catalogue every "back" link and
 * sibling card points at. Nothing else in the page knows which market it is
 * rendering, which is what keeps the two routes from drifting apart.
 */
